...
def PickMKFFFewSets(currdata,thiscurr,thisSetList):
    ...
    if '12090' in currdata.keys():
        PickedSetList += ['k12090'+ifl for ifl in FlagList(thisSetList['12090'],'Fit','tsink29sm32',FitCutPicked['tsink29sm32'])]
        # PickedSetList += ['k12090'+ifl for ifl in FlagList(thisSetList['12090'],'Fit','tsink29sm64',FitCutPicked['tsink29sm64'])]
        # PickedSetList += ['k12090'+ifl for ifl in FlagList(thisSetList['12090'],'Fit','tsink29sm128',FitCutPicked['tsink29sm128'])]
        PickedSetList += ['k12090'+ifl for ifl in FlagList(thisSetList['12090'],'Fit','tsink29state1CMto20dt2',FitCutPicked['tsink29state1CM'])]
        PickedSetList += ['k12090'+ifl for ifl in FlagList(thisSetList['12090'],'TSFTsink','sm32',TSFCutPicked)]
        # elif kappa == 12104:
