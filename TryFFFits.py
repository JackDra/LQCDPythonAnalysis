        ...
        for nFF in iFFloop:
            ...
            if len(ydatain) < 2:
                ...
                if yZero == False:
                    ...
                    DPfit,DPfitAvg,DPfitChi = FitBoots(ydatain,xdatain,DPfitfun,derfun=DPfitfunDer)
                    ...
                    if Debug:
                        ...
                        for ix,iy in zip(xdatain, ydatain):
                            print ix, iy.Avg, iy.Std
                    DPfit,DPfitAvg,DPfitChi = FitBoots(ydatain,xdatain,DPfitfunOnePar,derfun=DPfitfunOneParDer)
