...
tflowlist = map(int,np.arange(0,99,10)) + map(int,np.arange(100,1000,40))
# tflowlist = [400]
...
if TimeInv:
    ...
    if kappa == 12:
        ...
        # DefPoFVarPicked = [[3,3],[1,3],[2,3],[4,3]] #Smaller stats, full matrix, 1,2,4 cycle through different smearings
        DefPoFVarPicked = [[4,3]] 
